...
class DefaultShapleyScorer(ShapleyScorer):
    def __init__(
        ...
        super(DefaultShapleyScorer, self).__init__(
            input_data_path, output_data_path, checkpoint_dir, subset
        )
    ...
    def load_model(self, checkpoint_dir: str):
        ...
        pipeline = transformers.pipeline(
            "sentiment-analysis", model=model, tokenizer="xlm-roberta-base"
        )
        return pipeline
